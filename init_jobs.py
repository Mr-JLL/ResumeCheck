    ...
    # ─────────────────────────────────────────────
    {
        ...
        "rules": [
            ...
            ("年限", "汽车行业压铸类相关产品经验≥2年", "hard",
             "须在汽车/压铸行业质量岗位累计≥2年，须明确写出公司和年限"),
            ("行业", "汽车/汽车零部件/压铸行业", "hard",
             "须直接在汽车/汽车零部件/压铸企业质量岗位任职"),
            ("体系", "熟悉IATF16949以及VDA6.3要求", "soft",
             "须有实际IATF16949/VDA6.3工作经历（内审/外审/体系维护），'了解'不满足"),
            ("工具", "掌握质量五大工具：APQP/PPAP/PFMEA/SPC/MSA", "soft",
             "须有具体使用五大工具的项目经历描述，仅列工具名称不满足"),
            ("英语", "英语CET-6以上，能作为工作语言（优先项）", "bonus",
             "须有实际英语工作场景（技术文件/对外沟通），仅列证书等级不满足"),
            ("能力", "能独立处理客户反馈并协调内部落实改善", "soft",
             "须有独立处理客诉的具体案例（问题描述/8D报告/整改措施）"),
        ],
    },
    # ─────────────────────────────────────────────
    {
